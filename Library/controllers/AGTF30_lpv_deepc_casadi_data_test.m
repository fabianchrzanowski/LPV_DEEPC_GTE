...
max_cols_per_wf = 1000;      % [EXPERIMENT] Reduce the amount of data columns per operating point
wf_decimation_factor = 1;   % [EXPERIMENT] Only use every N-th Wf operating point (e.g. 1 = all 32, 2 = 16, 3 = 11)
n_sys = 4;
...
controller_name = 'LPV DeePC (Data Test)';
save('Results/results_lpv_deepc_data_test.mat', 'y_hist', 'u_hist', 'wf_scheduler_hist', 'solve_times', 'time', 'ref_plot', 'controller_name', 'track_name');
fprintf('Saved results to Results/results_lpv_deepc_data_test.mat\n');
